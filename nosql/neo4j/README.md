...
*Conforme visualizado na ferramenta:*
![Exercise_9_8](images/exercicio_9_8.png)

**Exercise 9.9: Retrieve the names and roles for actors.**

`MATCH (p:Person)-[rel:ACTED_IN]->(m:Movie) RETURN p.name, collect(rel.roles)`

**Exercise 9.10: Retrieve information about any specific relationships.**

`MATCH (p:Person)-[r:HELPED]-(m:Movie) RETURN p.name, r.type, m.title`
